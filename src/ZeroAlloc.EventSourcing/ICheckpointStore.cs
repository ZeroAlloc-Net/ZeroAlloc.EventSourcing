...
public interface ICheckpointStore
{
    ...
    Task<StreamPosition?> ReadAsync(string consumerId, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    Task WriteAsync(string consumerId, StreamPosition position, CancellationToken ct = default);
    ...
    /// <param name="consumerId">Unique identifier for the consumer</param>
    /// <param name="ct">Cancellation token</param>
    Task DeleteAsync(string consumerId, CancellationToken ct = default);
}
